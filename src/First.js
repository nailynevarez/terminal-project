...
render() {
  return (
    ...
    (
      ...
      <p>This site contains content that some visitors may find triggering or disturbing (incarceration, suicide, abuse, eating-disorders, ptsd, sexual assault). Please continue with caution. </p>
