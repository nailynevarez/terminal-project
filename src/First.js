...
render() {
  return (
    ...
    (
      ...
      <p>This site contains written content that some visitors may find triggering or disturbing (incarceration, suicide, abuse, hunger). Please continue with caution. </p>
